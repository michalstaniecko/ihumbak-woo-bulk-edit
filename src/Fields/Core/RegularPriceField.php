...
final class RegularPriceField extends AbstractField
{
    ...
    {
        return __('Regular Price', 'ihumbak-woo-bulk-edit');
    }
    ...
    public function validate(mixed $value, array $context = []): true|string
    {
        ...
        if (! is_numeric($value) || (float) $value < 0) {
            return __('Regular price must be a non-negative number.', 'ihumbak-woo-bulk-edit');
        }
